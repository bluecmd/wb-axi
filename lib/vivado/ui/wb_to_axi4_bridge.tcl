...
proc init_gui { IPINST } {
  ...
  #Adding Group
  set Wishbone [ipgui::add_group $IPINST -name "Wishbone" -parent ${Page_0}]
  ...
  set C_M_AXI_ID_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_ID_WIDTH" -parent ${AXI}]
  set_property tooltip {Thread ID Width} ${C_M_AXI_ID_WIDTH}
  set C_M_AXI_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_ADDR_WIDTH" -parent ${AXI}]
  set_property tooltip {Width of Address Bus} ${C_M_AXI_ADDR_WIDTH}
  set C_M_AXI_DATA_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_DATA_WIDTH" -parent ${AXI} -widget comboBox]
  set_property tooltip {Width of Data Bus} ${C_M_AXI_DATA_WIDTH}
  set C_M_AXI_BUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_BUSER_WIDTH" -parent ${AXI}]
  set_property tooltip {Width of User Response Bus} ${C_M_AXI_BUSER_WIDTH}
  set C_M_AXI_RUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_RUSER_WIDTH" -parent ${AXI}]
  set_property tooltip {Width of User Read Data Bus} ${C_M_AXI_RUSER_WIDTH}
  set C_M_AXI_WUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_WUSER_WIDTH" -parent ${AXI}]
  set_property tooltip {Width of User Write Data Bus} ${C_M_AXI_WUSER_WIDTH}
  set C_M_AXI_ARUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_ARUSER_WIDTH" -parent ${AXI}]
  set_property tooltip {Width of User Read Address Bus} ${C_M_AXI_ARUSER_WIDTH}
  set C_M_AXI_AWUSER_WIDTH [ipgui::add_param $IPINST -name "C_M_AXI_AWUSER_WIDTH" -parent ${AXI}]
